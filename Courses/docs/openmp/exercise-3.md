...
| -----------   | -----------     | -----------------|
| Distribute iterations over the threads | #pragrma omp for | !$omp do         |


With the help of the above syntax the loops can be easily parallelized.
The figure below shows an example of how the loops are parallelized.
...
Therefore, each thead will handle `2` iterations.
...
??? example "Examples: Loops parallelization"
