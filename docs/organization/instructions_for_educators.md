...
For example, the Quantum Espresso course falls under Computational Chemistry (if you prefer another name, please let us know). Before the event, for promotional purposes, we need to publish the course introduction and learning outcomes. You might draw inspiration from this [existing courses](https://ncclux.github.io/NCC-Trainings/docs/openmp/).
